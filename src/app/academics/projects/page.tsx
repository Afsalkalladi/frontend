        ...
        const mockProjects: Project[] = [
          {
            ...
            description: 'Full-stack e-commerce application with user authentication, payment gateway, and admin panel',
          ...
          },
          {
            ...
            description: 'Python-based stock price prediction system using LSTM neural networks',
          ...
          },
          {
            ...
            description: 'Arduino-based smart home system with mobile app control and sensor monitoring',
            category: 'IoT',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 mt-2">Innovative projects and solutions by our students</p>
            </div>
          </div>
        </div>
      </div>
